...
class ContourWithData():
    ...
    def calculateRectTopLeftPointAndWidthAndHeight(self,cols):               # calculate bounding rect info
...
def main():
    ...
    imgTestingNumbers = cv2.imread("training_chars.png")            # read in training numbers image
